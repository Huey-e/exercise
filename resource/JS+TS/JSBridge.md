...
- [为什么需要 JSBridge？](#为什么需要-jsbridge)
  - [Node 架构](#node-架构)
- [为什么叫 JSBridge？](#为什么叫-jsbridge)
- [JSBridge 能做什么？](#jsbridge-能做什么)
- [JSBridge 是如何实现的？](#jsbridge-是如何实现的)
  - [WebView 是什么？](#webview-是什么)
    - [微信小程序中的 WebView](#微信小程序中的-webview)
  - [JavaScript 调用 Native — 实现方案一](#javascript-调用-native--实现方案一)
    - [【 注入 API 】](#-注入-api-)
    - [【 劫持 URL Scheme 】](#-劫持-url-scheme-)
      - [URL Scheme 是什么？](#url-scheme-是什么)
      - [劫持原理](#劫持原理)
    - [【 弹窗拦截 】](#-弹窗拦截-)
  - [Native 调用 JavaScript — 实现方案二](#native-调用-javascript--实现方案二)
    - [Android](#android)
    - [IOS](#ios)
- [最后](#最后)
...
![image_6cda9717.png](../images//image_6cda9717.png) 66A4AF0E.jpg
...
![image_a279ce54.png](../images//image_a279ce54.png)
...
![image_f30add8e.png](../images//image_f30add8e.png)
...
![image_e2c8377c.png](../images//image_e2c8377c.png) 6F98DD16.jpg
...
![image_ef637d98.png](../images//image_ef637d98.png) 6A9DCAFF.gif
...
![image_7c2834f4.png](../images//image_7c2834f4.png)
