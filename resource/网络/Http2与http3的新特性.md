- [前言](#前言)
- [一、HTTP/1.1发明以来发生了哪些变化？](#一http11发明以来发生了哪些变化)
- [二、HTTP/1.1的缺陷](#二http11的缺陷)
  - [1.高延迟--带来页面加载速度的降低](#1高延迟--带来页面加载速度的降低)
  - [2.无状态特性--带来的巨大HTTP头部](#2无状态特性--带来的巨大http头部)
  - [3.明文传输--带来的不安全性](#3明文传输--带来的不安全性)
  - [4.不支持服务器推送消息](#4不支持服务器推送消息)
- [三、SPDY 协议与 HTTP/2 简介](#三spdy-协议与-http2-简介)
  - [1.SPDY 协议](#1spdy-协议)
  - [2.HTTP/2 简介](#2http2-简介)
- [四、HTTP/2 新特性](#四http2-新特性)
  - [1.二进制传输](#1二进制传输)
  - [2.Header 压缩](#2header-压缩)
  - [3.多路复用](#3多路复用)
  - [4.Server Push](#4server-push)
  - [5.提高安全性](#5提高安全性)
- [六、HTTP/3 新特性](#六http3-新特性)
  - [1.HTTP/2 的缺点](#1http2-的缺点)
  - [2.HTTP/3简介](#2http3简介)
  - [3.QUIC新功能](#3quic新功能)
- [七、总结](#七总结)
- [参考文章](#参考文章)
...
![image_9acbcdfd.png](../images//image_9acbcdfd.png)
...
![image_04facbb2.png](../images//image_04facbb2.png)
...
![image_bf7bffa6.png](../images//image_bf7bffa6.png)
...
![image_b449b044.png](../images//image_b449b044.png)
...
![image_22c191ee.png](../images//image_22c191ee.png)
...
例如下图中的两个请求， 请求一发送了所有的头部字段，第二个请求则只需要发送差异数据，这样可以减少冗余数据，降低开销![image_a0a2e1d5.png](../images//image_a0a2e1d5.png)

### 3.多路复用 

在 HTTP/2 中引入了多路复用的技术。多路复用很好的解决了浏览器限制同一个域名下的请求数量的问题，同时也接更容易实现全速传输，毕竟新开一个 TCP 连接都需要慢慢提升传输速度。

大家可以通过 该链接 直观感受下 HTTP/2 比 HTTP/1 到底快了多少。![image_89c9243b.png](../images//image_89c9243b.png)在 HTTP/2 中，有了二进制分帧之后，HTTP /2 不再依赖 TCP 链接去实现多流并行了，在 HTTP/2中,
...
![image_1da764b3.png](../images//image_1da764b3.png)如上图所示，多路复用的技术可以只通过一个 TCP 连接就可以传输所有的请求数据。
...
![image_b2f420ff.png](../images//image_b2f420ff.png)
...
![image_0926af1c.png](../images//image_0926af1c.png)
...
![image_2e1006b2.png](../images//image_2e1006b2.png)
...
![image_39528150.png](../images//image_39528150.png)
...
![image_82472149.png](../images//image_82472149.png)
