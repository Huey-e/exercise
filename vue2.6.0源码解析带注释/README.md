...
1. 中间的**全局的容器**, 用来**存储**可以被触发（vue中刷新页面）的东西( 函数, 对象 )
...
1. compiler 编译用的
   - vue 使用**字符串**作为模板
   - 在编译文件夹中存放对 模板字符串的 解析的算法, 抽象语法树, 优化等等
