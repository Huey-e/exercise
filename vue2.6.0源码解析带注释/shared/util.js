...
export function isUndef (v: any): boolean %checks {  // 用来判断南传进来的值 是不是 undefined null
...
/**
 * Check if value is primitive.  判断是不是基本类型
 */
...
/**
 * Remove an item from an array. 在数组里删除一个元素
 */
 ...
 * 将驼峰命名转换成 用-连接的字符串 hyphenate('camelCase) --面试
 */
...
export function looseEqual (a: any, b: any): boolean {
  ...
  if (isObjectA && isObjectB) {
    try {
      const isArrayA = Array.isArray(a)  // Array.isArray  确定值是否为数组
